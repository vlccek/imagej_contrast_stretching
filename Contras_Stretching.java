...
public class Contras_Stretching extends PlugInFrame implements ActionListener
{
...
//        panelInputl.add(shiftField);
    ...
    public Contras_Stretching(String title)
    {
        super(title);
    }
...
class CSPlot extends Canvas implements MouseMotionListener, MouseListener
{
    ...
    public void mouseDragged(MouseEvent e)
    {
        ...
        Contras_Stretching.labelminmax.setText("(" + e.getX() + "," + (255 - e.getY()) + ")");
